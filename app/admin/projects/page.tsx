        ...
        <div className="space-y-8">
            <div className="flex justify-between items-center">
                ...
                <button
                    ...
                    className="bg-blue-600 hover:bg-blue-600/80 text-white font-black px-6 py-3 rounded-xl flex items-center transition-all shadow-lg"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {projects.map((project) => (
                    <div key={project._id} className="glass-panel rounded-[2rem] border border-blue-500/20 overflow-hidden group hover:border-primary/50 transition-all flex flex-col">
                        ...
                        <div className="p-8 space-y-4 flex-1">
                            <div className="flex items-center text-xs text-blue-500 font-black uppercase tracking-widest">
                ...
                {showModal && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
                        <motion.div
                            ...
                            className="bg-slate-900 w-full max-w-2xl rounded-[2.5rem] p-10 border border-blue-500/30"
                        >
                            <div className="flex justify-between items-center mb-10">
                                <h2 className="text-3xl font-black text-white tracking-tighter">Add Student Work</h2>
                                <button onClick={() => setShowModal(false)} className="text-gray-400 hover:text-white transition-colors p-2 bg-slate-900 border border-blue-500/20 rounded-full">
                                    <FiX size={20} />
                                </button>
                            </div>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="grid md:grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        ...
                                        <input
                                            type="text"
                                            className="w-full bg-slate-900 border border-blue-500/20 border border-blue-500/30 rounded-2xl py-4 px-6 text-white focus:ring-2 focus:ring-primary/50 outline-none"
                                ...
                                <div className="space-y-2">
                                    ...
                                    <textarea
                                        className="w-full bg-slate-900 border border-blue-500/20 border border-blue-500/30 rounded-2xl py-4 px-6 text-white focus:ring-2 focus:ring-primary/50 outline-none h-32 resize-none"
                                ...
                                <button
                                    type="submit"
                                    disabled={loading}
                                    className="w-full bg-blue-600 hover:shadow-2xl hover:shadow-primary/20 text-white font-black py-5 rounded-2xl text-lg transition-all"
                                >
